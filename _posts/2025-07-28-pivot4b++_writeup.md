...
<br>
気を付けないといけないことは、リターンアドレスのアドレスに`\0`が含まれる場合`(例:0x609e7d00a22b)`は無理なケースだと思われます。<br>
<br>
ASLRに祈りましょう👼
<br><br>
...
2回目のペイロードを作る前に、今回ROPを作るにも長さが8バイトしかないのでどこかにROP書くところを探します。<br>
...
`\x88UUUU`は、書き換えたリターンアドレスなので今回は使いません。<br>
